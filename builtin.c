...
/**
 * my_myhelp - changes the current directory of the process
 * @infoo: Structure containing potential arguments. Used to maintain
 *          constant function prototype.
 *  Return: Always 0
 */
int my_myhelp(info_t *infoo)
{
	char **arg_array;
